...
@Composable
fun MainScreen(mainNavController: NavHostController, authViewModel: AuthViewModel, notificationViewModel: NotificationViewModel, wishlistViewModel: WishlistViewModel) {
    ...
    // Track current tab for back handling
    val currentBottomTab by bottomNavController.currentBackStackEntryAsState()
    val currentBottomRoute = currentBottomTab?.destination?.route
